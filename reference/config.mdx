...
description: "Complete reference for repokernel.config.yaml — all fields: paths, policies, git, worktrees, automation, review, routing, parallel, chaining, and agents."
---
